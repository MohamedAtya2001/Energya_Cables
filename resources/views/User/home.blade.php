...
<body>
    ...
    <div class="Buttons">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6 col-sm-6 col-md-6">
                    <button class="option btn btn-success my-4 mx-auto d-block" data-sheet="finish">Finish</button>
                </div>

                <div class="col-lg-3 col-xs-6 col-sm-6 col-md-6">
                    <button class="option btn btn-success my-4 mx-auto d-block" data-sheet="hold">Hold</button>
                </div>

                <div class="col-lg-3 col-xs-6 col-sm-6 col-md-6">
                    <button class="option btn btn-success my-4 mx-auto d-block" data-sheet="rewind">Rewind</button>
                </div>
                    ...
                    <div class="carousel-item active">
                        <div class="popUp popUp_data_option1" id="Drowing_1" data-item="0">
                            ...
                            <div class="box">
                                ...
                                @if( count($drowingActuals) != 0 )
                                <div class="dataNotComplete">

                                    <div class="dropdownalert">
                                        <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                        <div class="dropdownalert-menu">
                                            @for($i = 0; $i < count($drowingActuals); $i++) <div class="dropdownalert-item" data-id="{{ $drowingActuals[$i]->id }}">
                                                <form action="{{ route('user.get.row.drowing') }}" data-id="{{ $drowingActuals[$i]->id }}">
                                                    @csrf
                                                    <button type="submit" class="btn text-warning">
                                                        {{ $drowingActuals[$i]->jopOrderNumber }}
                                                    </button>
                                                </form>
                                                @if( $i != (count($drowingActuals) - 1) )
                                                <hr data-id="{{ $drowingActuals[$i]->id }}" />
                                                @endif
                                        </div>
                                        @endfor
                                    </div>
                            ...
                            <div class="content">
                                ...
                                <form action="{{ route('user.findDrowingStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfDrowing">
                                    @csrf
                                    <div class="form-group">
                                        <label>Jop Order Number :</label>
                                        <input type="text" class="form-control d-inline ml-2 input" name="jopOrderNumber" aria-describedby="helpId" inputSearch required>
                                    </div>
                                ...
                                <form action="{{ route('user.drowing') }}" class="clearfix drowingActual" data-update="false" data-form-item="1">
                                    @csrf
                                    <i class="fas fa-trash-restore float-left d-none" onclick="clearDrowingSheet(0)"></i>
                                    ...
                                    <div class="row actual">
                                        ...
                                        <div class="col-sm-6 mb-3">
                                            <div class="item">
                                                <div class="form-group">
                                                    <label>Notes :</label>
                                                    <textarea type="text" maxlength="100" class="form-control d-inline ml-2" name="notes" data-error="notes" aria-describedby="helpId"></textarea>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="carousel-item">
                    <div class="popUp popUp_data_option1" id="Drowing_2" data-item="1">
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.drowing') }}" class="clearfix drowingActual" data-update="false" data-form-item="2">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearDrowingSheet(1)"></i>
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option1" id="Drowing_3" data-item="2">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.drowing') }}" class="clearfix drowingActual" data-update="false" data-form-item="3">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearDrowingSheet(2)"></i>
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
        ...
        <div class="carousel-item">
            <div class="popUp popUp_data_option1" id="Drowing_4" data-item="3">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('user.drowing') }}" class="clearfix drowingActual" data-update="false" data-form-item="4">
                        @csrf
                        <i class="fas fa-trash-restore float-left d-none" onclick="clearDrowingSheet(3)"></i>
                        <h2 class="text-center">Standard</h2>
                        <div class="row standard">
                ...
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option2" id="Stranding_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($strandingActuals); $i++) <div class="dropdownalert-item" data-id="{{ $strandingActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.stranding') }}" data-id="{{ $strandingActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $strandingActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($strandingActuals) - 1) )
                                            <hr data-id="{{ $strandingActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.findStrandingStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfStranding">
                                @csrf
                            ...
                            <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="1">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(0)"></i>
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
                                ...
                                <div class="row actual">
                                        ...
                                        <div class="item">
                                            <div class="form-group">
                                                ...
                                                <div class="fourthInput">
                                                    <input type="text" class="form-control d-inline ml-1 input" name="inputCard1" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputCard2" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputCard3" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputCard4" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Cage :</label>
                                                <div class="fourthInput">
                                                    <input type="text" class="form-control d-inline ml-1 input" name="cage1" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="cage2" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="cage3" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="cage4" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                ...
                                                <div class="fourthInput">
                                                    <input type="text" class="form-control d-inline ml-1 input" name="conductorDimActual_HS1" onblur="conductorDimActual(this)" placeholder="H*S" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="conductorDimActual_HS2" placeholder="H*S" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="conductorDimActual_HS3" placeholder="H*S" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="conductorDimActual_HS4" placeholder="H*S" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                ...
                                                <div class="fourthInput">
                                                    <input type="text" class="form-control d-inline ml-1 input" name="conductorDimActual_FI1" onblur="conductorDimActual(this)" placeholder="&phi;" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="conductorDimActual_FI2" placeholder="&phi;" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="conductorDimActual_FI3" placeholder="&phi;" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="conductorDimActual_FI4" placeholder="&phi;" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Notes :</label>
                                                <textarea type="text" maxlength="100" class="form-control d-inline ml-2" name="notes" aria-describedby="helpId"></textarea>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option2" id="Stranding_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="2">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(1)"></i>
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
        ...
        <div class="carousel-item">
            <div class="popUp popUp_data_option2" id="Stranding_3" data-item="2">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="3">
                        @csrf
                        <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(2)"></i>
                        <h2 class="text-center">Standard</h2>
                        <div class="row standard">
    ...
    <div class="carousel-item">
        <div class="popUp popUp_data_option2" id="Stranding_4" data-item="3">
            ...
            <div class="content">
                ...
                <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="4">
                    @csrf
                    <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(3)"></i>
                    <h2 class="text-center">Standard</h2>
                    <div class="row standard">
    ...
    <div class="carousel-item">
        <div class="popUp popUp_data_option2" id="Stranding_5" data-item="4">
            ...
            <div class="content">
                ...
                <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="5">
                    @csrf
                    <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(4)"></i>
                    <h2 class="text-center">Standard</h2>
                    <div class="row standard">
    ...
    <div class="carousel-item">
        <div class="popUp popUp_data_option2" id="Stranding_6" data-item="5">
            ...
            <div class="content">
                ...
                <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="6">
                    @csrf
                    <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(5)"></i>
                    <h2 class="text-center">Standard</h2>
                    <div class="row standard">
    ...
    <div class="carousel-item">
        <div class="popUp popUp_data_option2" id="Stranding_7" data-item="6">
            ...
            <div class="content">
                ...
                <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="7">
                    @csrf
                    <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(6)"></i>
                    <h2 class="text-center">Standard</h2>
                    <div class="row standard">
    ...
    <div class="carousel-item">
        <div class="popUp popUp_data_option2" id="Stranding_8" data-item="7">
            ...
            <div class="content">
                ...
                <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="8">
                    @csrf
                    <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(7)"></i>
                    <h2 class="text-center">Standard</h2>
                    <div class="row standard">
    ...
    <div class="carousel-item">
        <div class="popUp popUp_data_option2" id="Stranding_9" data-item="8">
            ...
            <div class="content">
                ...
                <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="9">
                    @csrf
                    <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(8)"></i>
                    <h2 class="text-center">Standard</h2>
                    <div class="row standard">
    ...
    <div class="carousel-item">
        <div class="popUp popUp_data_option2" id="Stranding_10" data-item="9">
            ...
            <div class="content">
                ...
                <form action="{{ route('user.stranding') }}" class="clearfix strandingActual" data-update="false" data-form-item="10">
                    @csrf
                    <i class="fas fa-trash-restore float-left d-none" onclick="clearStrandingSheet(9)"></i>
                    <h2 class="text-center">Standard</h2>
                    <div class="row standard">
                ...
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option3" id="Insulation_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($insulationActuals); $i++) <div class="dropdownalert-item" data-id="{{ $insulationActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.insulation') }}" data-id="{{ $insulationActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $insulationActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($insulationActuals) - 1) )
                                            <hr data-id="{{ $insulationActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.findInsulationStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfInsulation">
                                @csrf
                            ...
                            <form action="{{ route('user.insulation') }}" class="clearfix insulationActual" data-update="false" data-form-item="1">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearInsulationSheet(0)"></i>
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option3" id="Insulation_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.insulation') }}" class="clearfix insulationActual" data-update="false" data-form-item="2">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearInsulationSheet(1)"></i>
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
        ...
        <div class="carousel-item">
            <div class="popUp popUp_data_option3" id="Insulation_3" data-item="2">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('user.insulation') }}" class="clearfix insulationActual" data-update="false" data-form-item="3">
                        @csrf
                        <i class="fas fa-trash-restore float-left d-none" onclick="clearInsulationSheet(2)"></i>
                        <h2 class="text-center">Standard</h2>
                        <div class="row standard">
                    ...
                    <div class="popUp popUp_data_option1" id="CCVInsulation_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($CCVInsulationActuals); $i++) <div class="dropdownalert-item" data-id="{{ $CCVInsulationActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.CCVInsulation') }}" data-id="{{ $CCVInsulationActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $CCVInsulationActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($CCVInsulationActuals) - 1) )
                                            <hr data-id="{{ $CCVInsulationActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.CCVInsulation') }}" class="clearfix CCVInsulationActual" data-update="false" data-form-item="1">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearCCVInsulationSheet(0)"></i>
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
                ...
                <div class="popUp popUp_data_option2" id="CCVInsulation_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.CCVInsulation') }}" class="clearfix CCVInsulationActual" data-update="false" data-form-item="2">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearCCVInsulationSheet(1)"></i>
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
            ...
            <div class="popUp popUp_data_option3" id="CCVInsulation_3" data-item="2">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('user.CCVInsulation') }}" class="clearfix CCVInsulationActual" data-update="false" data-form-item="3">
                        @csrf
                        <i class="fas fa-trash-restore float-left d-none" onclick="clearCCVInsulationSheet(2)"></i>
                        <h2 class="text-center">Standard</h2>
                        <div class="row standard">
                ...
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option4" id="Screen_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($screenActuals); $i++) <div class="dropdownalert-item" data-id="{{ $screenActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.screen') }}" data-id="{{ $screenActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $screenActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($screenActuals) - 1) )
                                            <hr data-id="{{ $screenActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.findScreenStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfScreen">
                                @csrf
                            ...
                            <form action="{{ route('user.screen') }}" class="clearfix screenActual" data-update="false" data-form-item="1">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearScreenSheet(0)"></i>
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option4" id="Screen_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.screen') }}" class="clearfix screenActual" data-update="false" data-form-item="2">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearScreenSheet(1)"></i>
                            <h2 class="text-center">Strandard</h2>
                            <div class="row standard">
        ...
        <div class="carousel-item">
            <div class="popUp popUp_data_option4" id="Screen_3" data-item="2">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('user.screen') }}" class="clearfix screenActual" data-update="false" data-form-item="3">
                        @csrf
                        <i class="fas fa-trash-restore float-left d-none" onclick="clearScreenSheet(2)"></i>
                        <h2 class="text-center">Strandard</h2>
                        <div class="row standard">
                ...
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option5" id="Assembly_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($assemblyActuals); $i++) <div class="dropdownalert-item" data-id="{{ $assemblyActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.assembly') }}" data-id="{{ $assemblyActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $assemblyActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($assemblyActuals) - 1) )
                                            <hr data-id="{{ $assemblyActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.findAssemblyStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfAssembly">
                                @CSRF
                            ...
                            <form action="{{ route('user.assembly') }}" class="clearfix assemblyActual" data-update="false" data-form-item="1">
                                @CSRF
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearAssemblySheet(0)"></i>
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
                                        ...
                                        <div class="item">
                                            <div class="form-group">
                                                ...
                                                <div class="fifthInput">
                                                    <input type="text" class="form-control d-inline ml-1 input" name="inputDrum1" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputDrum2" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputDrum3" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputDrum4" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputDrum5" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="item">
                                            <div class="form-group">
                                                ...
                                                <div class="fifthInput">
                                                    ...
                                                    <input type="text" class="form-control d-inline input" name="inputCard3" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputCard4" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputCard5" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Input Length :</label>
                                                <div class="fifthInput">
                                                    <input type="text" class="form-control d-inline ml-1 input" name="inputLength1" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputLength2" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputLength3" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputLength4" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="inputLength5" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Color :</label>
                                                <div class="fifthInput">
                                                    <input type="text" class="form-control d-inline ml-1 input" name="color1" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="color2" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="color3" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="color4" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="color5" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Outer Dim:</label>
                                                <div class="thirdInput">
                                                    <input type="text" class="form-control d-inline ml-1 input" name="outerDimMinActual" aria-describedby="helpId" placeholder="Min" required>
                                                    <input type="text" class="form-control d-inline input" name="outerDimNomActual" aria-describedby="helpId" placeholder="Nom" required>
                                                    <input type="text" class="form-control d-inline input" name="outerDimMaxActual" aria-describedby="helpId" placeholder="Max" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="row twisted">
                                                <label>Filler :</label>
                                                <div class="fix-group">
                                                    <input type="text" class="form-control d-inline ml-2 input twisted_input" name="fillerActual" aria-describedby="helpId">
                                                    <select class="form-control d-inline input twisted_select" name="twistedActual" aria-describedby="helpId">
                                                        <option value="Twisted">Twisted</option>
                                                        <option value="Not Twisted">Not Twisted</option>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                ...
                                                <div class="secondInput">
                                                    <input type="text" class="form-control d-inline ml-1 input" name="ppTapeSize" placeholder="Size" aria-describedby="helpId">
                                                    <input type="text" class="form-control d-inline input" name="ppTapeOverLap" placeholder="OverLap" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option5" id="Assembly_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.assembly') }}" class="clearfix assemblyActual" data-update="false" data-form-item="2">
                            @CSRF
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearAssemblySheet(1)"></i>
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
        ...
        <div class="carousel-item">
            <div class="popUp popUp_data_option5" id="Assembly_3" data-item="2">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('user.assembly') }}" class="clearfix assemblyActual" data-update="false" data-form-item="3">
                        @CSRF
                        <i class="fas fa-trash-restore float-left d-none" onclick="clearAssemblySheet(2)"></i>
                        <h2 class="text-center">Standard</h2>
                        <div class="row standard">
                ...
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option3" id="Bedding_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($beddingActuals); $i++) <div class="dropdownalert-item" data-id="{{ $beddingActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.bedding') }}" data-id="{{ $beddingActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $beddingActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($beddingActuals) - 1) )
                                            <hr data-id="{{ $beddingActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.findBeddingStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfBedding">
                                @csrf
                            ...
                            <form action="{{ route('user.bedding') }}" class="clearfix beddingActual" data-update="false" data-form-item="1">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearBeddingSheet(0)"></i>
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option3" id="Bedding_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.bedding') }}" class="clearfix beddingActual" data-update="false" data-form-item="2">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearBeddingSheet(1)"></i>
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
                ...
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option7" id="Armouring_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($armouringActuals); $i++) <div class="dropdownalert-item" data-id="{{ $armouringActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.armouring') }}" data-id="{{ $armouringActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $armouringActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($armouringActuals) - 1) )
                                            <hr data-id="{{ $armouringActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.findArmouringStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfArmouring">
                                @csrf
                            ...
                            <form action="{{ route('user.armouring') }}" class="clearfix armouringActual" data-update="false" data-form-item="1">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearArmouringSheet(0)"></i>
                                @csrf
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option7" id="Armouring_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.armouring') }}" class="clearfix armouringActual" data-update="false" data-form-item="2">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearArmouringSheet(1)"></i>
                            @csrf
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
                ...
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option1" id="Lead_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            @if( count($leadActuals) != 0 )
                            <div class="dataNotComplete">

                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($leadActuals); $i++) <div class="dropdownalert-item" data-id="{{ $leadActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.lead') }}" data-id="{{ $leadActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $leadActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($leadActuals) - 1) )
                                            <hr data-id="{{ $leadActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.findLeadStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfLead">
                                @csrf
                            ...
                            <form action="{{ route('user.lead') }}" class="clearfix leadActual" data-update="false" data-form-item="1">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearLeadSheet(0)"></i>
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option2" id="Lead_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.lead') }}" class="clearfix leadActual" data-update="false" data-form-item="2">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearLeadSheet(1)"></i>
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
        ...
        <div class="carousel-item">
            <div class="popUp popUp_data_option3" id="Lead_3" data-item="2">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('user.lead') }}" class="clearfix leadActual" data-update="false" data-form-item="3">
                        @csrf
                        <i class="fas fa-trash-restore float-left d-none" onclick="clearLeadSheet(2)"></i>
                        <h2 class="text-center">Standard</h2>
                        <div class="row standard">
                ...
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option9" id="Taps_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($tapsActuals); $i++) <div class="dropdownalert-item" data-id="{{ $tapsActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.taps') }}" data-id="{{ $tapsActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $tapsActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($tapsActuals) - 1) )
                                            <hr data-id="{{ $tapsActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.findTapsStandard') }}" class="clearfix  numberOfJopOrder searchJopOrderNumberOfTaps">
                                @csrf
                            ...
                            <form action="{{ route('user.taps') }}" class="clearfix tapsActual" data-update="false" data-form-item="1">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearTapsSheet(0)"></i>
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Tape Dimention :</label>
                                                <input type="text" class="form-control d-inline ml-2 input" name="tapeDimentionStandard" aria-describedby="helpId" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Tape Weight :</label>
                                                <input type="text" class="form-control d-inline ml-2 input" name="tapeWeightStandard" aria-describedby="helpId" required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row actual">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Tape Dimention :</label>
                                                <input type="text" class="form-control d-inline ml-2 input" name="tapeDimentionActual" aria-describedby="helpId">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Tape Weight :</label>
                                                <input type="text" class="form-control d-inline ml-2 input" name="tapeWeightActual" aria-describedby="helpId">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Over Lap :</label>
                                                <input type="text" class="form-control d-inline ml-2 input" name="overLapActual" aria-describedby="helpId">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="item">
                                            <div class="form-group">
                                                <label>Dim After :</label>
                                                <input type="text" class="form-control d-inline ml-2 input" name="dimAfter" aria-describedby="helpId">
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option9" id="Taps_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.taps') }}" class="clearfix tapsActual" data-update="false" data-form-item="2">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearTapsSheet(1)"></i>
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
                ...
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option3" id="Sheathing_1" data-item="0">
                        ...
                        <div class="box">
                            ...
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    <div class="btn btn-warning text-light dropdownalert-button">Alerts<i class="fas fa-chevron-down"></i></div>
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($sheathingActuals); $i++) <div class="dropdownalert-item" data-id="{{ $sheathingActuals[$i]->id }}">
                                            <form action="{{ route('user.get.row.sheathing') }}" data-id="{{ $sheathingActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                                    {{ $sheathingActuals[$i]->jopOrderNumber }}
                                                </button>
                                            </form>
                                            @if( $i != (count($sheathingActuals) - 1) )
                                            <hr data-id="{{ $sheathingActuals[$i]->id }}" />
                                            @endif
                                    </div>
                                    @endfor
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('user.findSheathingStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfSheathing">
                                @csrf
                            ...
                            <form action="{{ route('user.sheathing') }}" class="clearfix sheathingActual" data-update="false" data-form-item="1">
                                @csrf
                                <i class="fas fa-trash-restore float-left d-none" onclick="clearSheathingSheet(0)"></i>
                                <h2 class="text-center">Standard</h2>
                                <div class="row standard">
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option3" id="Sheathing_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('user.sheathing') }}" class="clearfix sheathingActual" data-update="false" data-form-item="2">
                            @csrf
                            <i class="fas fa-trash-restore float-left d-none" onclick="clearSheathingSheet(1)"></i>
                            <h2 class="text-center">Standard</h2>
                            <div class="row standard">
        ...
        <div class="carousel-item">
            <div class="popUp popUp_data_option3" id="Sheathing_3" data-item="2">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('user.sheathing') }}" class="clearfix sheathingActual" data-update="false" data-form-item="3">
                        @csrf
                        <i class="fas fa-trash-restore float-left d-none" onclick="clearSheathingSheet(2)"></i>
                        <h2 class="text-center">Standard</h2>
                        <div class="row standard">
    ...
    <div class="carousel-item">
        <div class="popUp popUp_data_option3" id="Sheathing_4" data-item="3">
            ...
            <div class="content">
                ...
                <form action="{{ route('user.sheathing') }}" class="clearfix sheathingActual" data-update="false" data-form-item="4">
                    @csrf
                    <i class="fas fa-trash-restore float-left d-none" onclick="clearSheathingSheet(3)"></i>
                    <h2 class="text-center">Standard</h2>
                    <div class="row standard">
    ...
    <div class="finish">
        <div class="popUp popUp_data_option11" id="Finish_1">
            ...
            <div class="box">
                ...
                <form action="{{ route('user.finish') }}" class="clearfix finishForm">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    <label>Drum Number :</label>
                                    <input type="text" class="form-control d-inline ml-2 input" name="drumNumber" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    <label>Length :</label>
                                    <input type="text" class="form-control d-inline ml-2 input" name="length" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
    ...
    <div class="hold">
        ...
        <div class="popUp popUp_data_option11" id="Hold_1">

            <div class="box">
                <i class="fas fa-minus-circle"></i>

                <h2 class="text-center">Hold</h2>

                <form action="{{ route('user.hold') }}" class="clearfix holdForm">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    <label>Machine :</label>
                                    <input type="text" class="form-control d-inline ml-2 input" name="machine" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" maxlength="100" class="form-control d-inline ml-2" name="reasonOfHold" aria-describedby="helpId" required></textarea>
                                </div>
                            </div>
                        </div>
    ...
    <div class="rewind">
        ...
        <div class="popUp popUp_data_option11" id="Rewind_1">

            <div class="box">
                <i class="fas fa-minus-circle"></i>

                <h2 class="text-center">Rewind</h2>

                <form action="{{ route('user.rewind') }}" class="clearfix">
                    @csrf
                    <div class="row rewindForm">
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    <label>Input Drum :</label>
                                    <input type="text" class="form-control d-inline ml-2 input" name="inputDrum" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    <label>Input Card :</label>
                                    <input type="text" class="form-control d-inline ml-2 input" name="inputCard" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    <label>Input Length :</label>
                                    <input type="text" class="form-control d-inline ml-2 input" name="inputLength" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    <label>Output Drum :</label>
                                    <input type="text" class="form-control d-inline ml-2 input" name="outputDrum" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    <label>Output Card :</label>
                                    <input type="text" class="form-control d-inline ml-2 input" name="outputCard" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    <label>Output Length :</label>
                                    <input type="text" class="form-control d-inline ml-2 input" name="outputLength" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="item">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" maxlength="100" class="form-control d-inline ml-2" name="reasonOfRewind" aria-describedby="helpId" required></textarea>
                                </div>
                            </div>
                        </div>
    ...
    <script src="{{ asset('layout/JavaScript/Home/User/Drowing.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Stranding.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Insulation.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Bedding.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Sheathing.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Screen.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Assembly.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Armouring.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Taps.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Finish.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Hold.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Rewind.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Lead.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/CCVInsulation.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/User/Home.js') }}"></script>
</body>
