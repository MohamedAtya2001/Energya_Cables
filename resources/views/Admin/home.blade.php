...
<body>
                                    ...
                                    <div class="dropdownalert">
                                        ...
                                        <div class="dropdownalert-menu">
                                            @for($i = 0; $i < count($drowingActuals); $i++) <div class="dropdownalert-item" data-id="{{ $drowingActuals[$i]->id }}">
                                                <form action="{{ route('admin.get.row.drowing') }}" data-id="{{ $drowingActuals[$i]->id }}">
                                                    @csrf
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($strandingActuals); $i++) <div class="dropdownalert-item" data-id="{{ $strandingActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.stranding') }}" data-id="{{ $strandingActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                    ...
                    <div class="popUp popUp_data_option3" id="Insulation_1" data-item="0">
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($insulationActuals); $i++) <div class="dropdownalert-item" data-id="{{ $insulationActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.insulation') }}" data-id="{{ $insulationActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('admin.findInsulationStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfInsulation">
                                @csrf
                                <h2 class="text-center">L.V Insulation Page 1</h2>
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option3" id="Insulation_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('admin.findInsulationStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfInsulation">
                            @csrf
                            <h2 class="text-center">L.V Insulation Page 2</h2>
        ...
        <div class="carousel-item">
            <div class="popUp popUp_data_option3" id="Insulation_3" data-item="2">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('admin.findInsulationStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfInsulation">
                        @csrf
                        <h2 class="text-center">L.V Insulation Page 3</h2>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="popUp popUp_data_option1" id="CCVInsulation_1" data-item="0">
                        ...
                        <div class="box">
                            <i class="fas fa-minus-circle"></i>
                            @if( count($CCVInsulationActuals) != 0 )
                            <div class="dataNotComplete">
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($CCVInsulationActuals); $i++) <div class="dropdownalert-item" data-id="{{ $CCVInsulationActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.CCVInsulation') }}" data-id="{{ $CCVInsulationActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('admin.findCCVInsulationStandard') }}" class="clearfix numberOfJopOrder searchJopOrderNumberOfCCVInsulation">
                                @csrf
                            ...
                            <form action="{{ route('admin.CCVInsulation') }}" class="clearfix CCVInsulationActual" data-update="false" data-form-item="1">
                                @csrf
            ...
            <div class="carousel-item">
                <div class="popUp popUp_data_option2" id="CCVInsulation_2" data-item="1">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('admin.CCVInsulation') }}" class="clearfix CCVInsulationActual" data-update="false" data-form-item="2">
                            @csrf
        ...
        <div class="carousel-item">
            <div class="popUp popUp_data_option3" id="CCVInsulation_3" data-item="2">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('admin.CCVInsulation') }}" class="clearfix CCVInsulationActual" data-update="false" data-form-item="3">
                        @csrf
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($screenActuals); $i++) <div class="dropdownalert-item" data-id="{{ $screenActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.screen') }}" data-id="{{ $screenActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($assemblyActuals); $i++) <div class="dropdownalert-item" data-id="{{ $assemblyActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.assembly') }}" data-id="{{ $assemblyActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($beddingActuals); $i++) <div class="dropdownalert-item" data-id="{{ $beddingActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.bedding') }}" data-id="{{ $beddingActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($armouringActuals); $i++) <div class="dropdownalert-item" data-id="{{ $armouringActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.armouring') }}" data-id="{{ $armouringActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($leadActuals); $i++) <div class="dropdownalert-item" data-id="{{ $leadActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.lead') }}" data-id="{{ $leadActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($tapsActuals); $i++) <div class="dropdownalert-item" data-id="{{ $tapsActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.taps') }}" data-id="{{ $tapsActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
                                ...
                                <div class="dropdownalert">
                                    ...
                                    <div class="dropdownalert-menu">
                                        @for($i = 0; $i < count($sheathingActuals); $i++) <div class="dropdownalert-item" data-id="{{ $sheathingActuals[$i]->id }}">
                                            <form action="{{ route('admin.get.row.sheathing') }}" data-id="{{ $sheathingActuals[$i]->id }}">
                                                @csrf
                                                <button type="submit" class="btn text-warning">
    ...
    <div class="finish">
        <div class="popUp popUp_data_option11" id="Finish_1">
            ...
            <div class="box">
                ...
                <form action="{{ route('admin.finish') }}" class="clearfix finishForm">
                    @csrf
                    <div class="row">
    ...
    <div class="hold">
        ...
        <div class="popUp popUp_data_option11" id="Hold_1">
            ...
            <div class="box">
                ...
                <form action="{{ route('admin.hold') }}" class="clearfix holdForm">
                    @csrf
                    <div class="row">
    ...
    <div class="rewind">
        ...
        <div class="popUp popUp_data_option11" id="Rewind_1">
            ...
            <div class="box">
                ...
                <form action="{{ route('admin.rewind') }}" class="clearfix">
                    @csrf
    ...
    <script src="{{ asset('layout/JavaScript/Home/Admin/Drowing.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Stranding.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Insulation.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Bedding.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Sheathing.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Screen.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Assembly.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Armouring.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Taps.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Finish.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Hold.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Rewind.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/Lead.js') }}"></script>
    <script src="{{ asset('layout/JavaScript/Home/Admin/CCVInsulation.js') }}"></script>
