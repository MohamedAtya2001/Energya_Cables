...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('layout/css/Reports/Printer/Extrusion/PrinterExtrusion.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('report.extrusion') }}">Extrusion</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Extrusion Report</h1>
    </div>
    ...
    <div id="Remark">
        <div class="box clearfix report">
            ...
            <form action="{{ route('report.remark.extrusion') }}" class="clearfix">
                @csrf
    ...
    <div id="Data" data-logoSrc="{{ asset('layout/images/Home/logo.gif') }}">
        ...
        <div class="sheets">
                ...
                <div class="filterValue mx-auto">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-12 col-sm-6 col-md-5">
                            ...
                            <div id="Process" class="form-control">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="insulation" id="Insulation" onclick="processFilter(this)" checked>
                                    <label class="custom-control-label" for="Insulation"><abbr title="Insulation">Ins</abbr></label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="bedding" id="Bedding" onclick="processFilter(this)" checked>
                                    <label class="custom-control-label" for="Bedding"><abbr title="Bedding">Bed</abbr></label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="sheathing" id="Sheathing" onclick="processFilter(this)" checked>
                                    <label class="custom-control-label" for="Sheathing"><abbr title="Sheathing">She</abbr></label>
                                </div>
                            </div>
            ...
            <button class="float-right d-none btn mr-3 mb-3" data-insulation-count-rows="10" data-bedding-count-rows="10" data-sheathing-count-rows="10" id="Limit">
                <i class="bug fas fa-exclamation-triangle d-none text-warning"></i>
                <span class="spinner spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span>
                <span>See More</span>
            </button>
    ...
    <script src="{{ asset('layout/JavaScript/Reports/ExtrusionReport.js') }}"></script>
