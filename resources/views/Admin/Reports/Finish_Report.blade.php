...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('layout/css/Reports/Printer/Finish/PrinterFinish.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('report.finish') }}">Finish</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Finish Report</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('finish.edit.row') }}" class="clearfix">
                @csrf
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="jopOrderNumber" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="filterValue mx-auto">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-6 col-md-5">
                            <select class="form-control d-inline input" name="fillerName" id="FilterName" aria-describedby="helpId" data-last-selected="shift" required>
    ...
    <script src="{{ asset('layout/JavaScript/Reports/FinishReport.js') }}"></script>
