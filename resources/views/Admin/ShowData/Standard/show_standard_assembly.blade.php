...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.standard.assembly') }}">Assembly</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Assembly Standard Sheets</h1>
    </div>

    <div id="Edit">
        <div class="box clearfix">
            <i class="far fa-times-circle"></i>
            <h2 class="text-center my-4">Edit Assembly</h2>

            <form action="{{ route('assembly.standard.edit.row') }}" class="clearfix">
                @csrf
                        ...
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="outerDimMinStandard" aria-describedby="helpId" placeholder="Min" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="outerDimNomStandard" aria-describedby="helpId" placeholder="Nom" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="outerDimMaxStandard" aria-describedby="helpId" placeholder="Max" required autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="row twisted">
                                ...
                                <div class="fix-group">
                                    <input type="text" class="form-control d-inline ml-2 input twisted_input" name="fillerStandard" aria-describedby="helpId" required autocomplete="off">
                                    <select class="form-control d-inline input twisted_select" name="twistedStandard" aria-describedby="helpId" required autocomplete="off">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="overLap" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
    ...
    <div id="Data">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.actual.assembly') }}"><button class="btn btn-assembly float-left">Show Actual</button></a>
            </div>
        </div>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Standard/ShowStandardAssembly.js') }}"></script>
