...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.standard.bedding') }}">Bedding</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Bedding Standard Sheets</h1>
    </div>

    <div id="Edit">
        <div class="box clearfix">
            <i class="far fa-times-circle"></i>
            <h2 class="text-center my-4">Edit Bedding</h2>

            <form action="{{ route('bedding.standard.edit.row') }}" class="clearfix">
                @csrf
    ...
    <div id="Data">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.actual.bedding') }}"><button class="btn btn-bedding float-left">Show Actual</button></a>
            </div>
        </div>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Standard/ShowStandardBedding.js') }}"></script>
