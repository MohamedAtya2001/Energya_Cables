...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item active" href="{{ route('admin.show.standard.drowing') }}">Dowing</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Drowing Standard Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('drowing.standard.edit.row') }}" class="clearfix">
                @csrf
                ...
                <div class="row strandard">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="jopOrderNumber" data-error="jopOrderNumber" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="wireDimMinStandard" aria-describedby="helpId" placeholder="Min" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="wireDimNomStandard" aria-describedby="helpId" placeholder="Nom" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="wireDimMaxStandard" aria-describedby="helpId" placeholder="Max" required autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label> Size:</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="size" data-error="size" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Volt :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="volt" data-error="volt" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="elongationStandard" data-error="elongationStandard" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Tensile :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="tensileStandard" data-error="tensileStandard" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
    ...
    <div id="Data">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.actual.drowing') }}"><button class="btn btn-drowing float-left">Show Actual</button></a>
            </div>
        </div>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Standard/ShowStandardDrowing.js') }}"></script>
