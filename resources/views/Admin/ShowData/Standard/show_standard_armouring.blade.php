...
<head>
    ...
    <title>Armouring Standard</title>
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.standard.armouring') }}">Armouring</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Armouring Standard Sheets</h1>
    </div>

    <div id="Edit">
        <div class="box clearfix">
            <i class="far fa-times-circle"></i>
            <h2 class="text-center my-4">Edit Armouring</h2>

            <form action="{{ route('armouring.standard.edit.row') }}" class="clearfix">
                @csrf
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="overGapStandard" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="numberOfWire_wireDim" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
    ...
    <div id="Data">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.actual.armouring') }}"><button class="btn btn-armouring float-left">Show Actual</button></a>
            </div>
        </div>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Standard/ShowStandardArmouring.js') }}"></script>
