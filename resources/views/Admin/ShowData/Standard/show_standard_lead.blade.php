...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.standard.lead') }}">Lead</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Lead Standard Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('lead.standard.edit.row') }}" class="clearfix">
                @csrf
    ...
    <div id="Data">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.actual.lead') }}"><button class="btn btn-lead float-left">Show Actual</button></a>
            </div>
        </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-6 col-md-5">
                            <select class="form-control d-inline input" name="fillerName" id="FilterName" aria-describedby="helpId" required>
                                ...
                                <option value="weightStandard">Weight</option>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Standard/ShowStandardLead.js') }}"></script>
