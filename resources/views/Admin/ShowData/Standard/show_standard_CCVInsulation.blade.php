...
<head>
    ...
    <title>CCV Insulation Standard</title>
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.standard.CCVInsulation') }}">CCV Insulation</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">CCV Insulation Standard Sheets</h1>
    </div>

    <div id="Edit">
        <div class="box clearfix">
            <i class="far fa-times-circle"></i>
            <h2 class="text-center my-4">Edit Insulation</h2>

            <form action="{{ route('CCVInsulation.standard.edit.row') }}" class="clearfix">
                @csrf
                ...
                <div class="row standard">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Size :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="size" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="description" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessMinISC" aria-describedby="helpId" placeholder="ISC" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="thicknessMinINS" aria-describedby="helpId" placeholder="INS" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="thicknessMinOSC" aria-describedby="helpId" placeholder="OSC" required autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessNomISC" aria-describedby="helpId" placeholder="ISC" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="thicknessNomINS" aria-describedby="helpId" placeholder="INS" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="thicknessNomOSC" aria-describedby="helpId" placeholder="OSC" required autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="dimAfter" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
    ...
    <div id="Data">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.actual.CCVInsulation') }}"><button class="btn btn-CCVInsulation float-left">Show Actual</button></a>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <th class="text-center pb-0 threeColumns" colspan="3">
                                ...
                                <div class="row m-0 mt-2">
                                    <span class="col-4 p-0 m-0 px-2 text-center">ISC</span>
                                    <span class="col-4 p-0 m-0 px-2 text-center">INS</span>
                                    <span class="col-4 p-0 m-0 px-2 text-center">OSC</span>
                                </div>
                            </th>
                            <th class="text-center pb-0 threeColumns" colspan="3">
                                Thickness Nom
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Standard/ShowStandardCCVInsulation.js') }}"></script>
