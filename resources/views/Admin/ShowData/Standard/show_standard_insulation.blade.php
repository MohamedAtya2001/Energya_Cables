...
<head>
    ...
    <title>L.V Insulation Standard</title>
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.standard.insulation') }}">L.V Insulation</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">L.V Insulation Standard Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('insulation.standard.edit.row') }}" class="clearfix">
                @csrf
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="masterPatch" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
    ...
    <div id="Data">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.actual.insulation') }}"><button class="btn btn-insulation float-left">Show Actual</button></a>
            </div>
        </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-6 col-md-5">
                            <select class="form-control d-inline input" name="fillerName" id="FilterName" aria-describedby="helpId" required>
                                ...
                                <option value="materialStandard">Material</option>
                                <option value="colorStandard">Color</option>
                                <option value="weightStandard">Weight</option>
                                <option value="masterPatch">Master Patch</option>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Standard/ShowStandardInsulation.js') }}"></script>
