...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('layout/css/ShowData/Printer/Bedding/PrinterBedding.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.actual.bedding') }}">Bedding</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Bedding Actual Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('bedding.edit.row') }}" class="clearfix">
                @csrf
                ...
                <div class="row actual">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="inputDrum" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="inputCard" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="inputLength" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="outputDrum" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="outputLength" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Color :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="colorActual" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessStartMinActual" aria-describedby="helpId" autocomplete="off" required placeholder="Min">
                                    <input type="text" class="form-control d-inline input" name="thicknessStartNomActual" aria-describedby="helpId" autocomplete="off" required placeholder="Nom">
                                    <input type="text" class="form-control d-inline input" name="thicknessStartMaxActual" aria-describedby="helpId" autocomplete="off" required placeholder="Max">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessEndMinActual" aria-describedby="helpId" autocomplete="off" required placeholder="Min">
                                    <input type="text" class="form-control d-inline input" name="thicknessEndNomActual" aria-describedby="helpId" autocomplete="off" required placeholder="Nom">
                                    <input type="text" class="form-control d-inline input" name="thicknessEndMaxActual" aria-describedby="helpId" autocomplete="off" required placeholder="Max">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="eccentricityActual" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="secondInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="dimBefore1" aria-describedby="helpId" autocomplete="off" required>
                                    <input type="text" class="form-control d-inline input" name="dimBefore2" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="dimAfterStartMin" aria-describedby="helpId" autocomplete="off" required placeholder="Min">
                                    <input type="text" class="form-control d-inline input" name="dimAfterStartNom" aria-describedby="helpId" autocomplete="off" required placeholder="Nom">
                                    <input type="text" class="form-control d-inline input" name="dimAfterStartMax" aria-describedby="helpId" autocomplete="off" required placeholder="Max">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="dimAfterEndMin" aria-describedby="helpId" autocomplete="off" required placeholder="Min">
                                    <input type="text" class="form-control d-inline input" name="dimAfterEndNom" aria-describedby="helpId" autocomplete="off" required placeholder="Nom">
                                    <input type="text" class="form-control d-inline input" name="dimAfterEndMax" aria-describedby="helpId" autocomplete="off" required placeholder="Max">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Weight :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="weightActual" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="materialActual" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Ovality :</label>
                                <div class="secondInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="ovalityActual1" aria-describedby="helpId" autocomplete="off" required>
                                    <input type="text" class="form-control d-inline input" name="ovalityActual2" aria-describedby="helpId" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Spark :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="sparkActual" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Notes :</label>
                                <textarea type="text" class="form-control d-inline ml-2" maxlength="100" name="notes" aria-describedby="helpId"></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <div id="Data" data-logoSrc="{{ asset('layout/images/Home/logo.gif') }}">
        <div class="jopOrderNumber w-50 m-auto">
            ...
            <form action="{{ route('bedding.get') }}" class="clearfix">
                @csrf
                <div class="form-group">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.standard.bedding') }}"><button class="btn btn-bedding float-left">Show Standards</button></a>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Actual/ShowActualBedding.js') }}"></script>
