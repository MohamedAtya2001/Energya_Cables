...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('layout/css/ShowData/Printer/Armouring/PrinterArmouring.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.actual.armouring') }}">Armouring</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Armouring Actual Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('armouring.edit.row') }}" class="clearfix">
                @csrf
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="wire_tape" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="overGapActual" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
    ...
    <div id="ISO">
        <div class="box clearfix">
            ...
            <form action="{{ route('armouring.iso') }}">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="item">
    ...
    <div id="Data" data-logoSrc="{{ asset('layout/images/Home/logo.gif') }}">
        ...
        <div class="jopOrderNumber w-50 m-auto">
            ...
            <form action="{{ route('armouring.get') }}" class="clearfix">
                @csrf
                <div class="form-group">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.standard.armouring') }}"><button class="btn btn-armouring float-left">Show Standards</button></a>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Actual/ShowActualArmouring.js') }}"></script>
