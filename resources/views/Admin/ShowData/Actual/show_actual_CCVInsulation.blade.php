...
<head>
    ...
    <title>CCV Insulation Actual</title>
    ...
    <link rel="stylesheet" href="{{ asset('layout/css/ShowData/Printer/CCVInsulation/PrinterCCVInsulation.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.actual.CCVInsulation') }}">CCV Insulation</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">CCV Insulation Actual Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('CCVInsulation.edit.row') }}" class="clearfix">
                @csrf
                        ...
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessISCStartMin" aria-describedby="helpId" required autocomplete="off" placeholder="Min" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessISCStartNom" aria-describedby="helpId" required autocomplete="off" placeholder="Nom" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessISCStartMax" aria-describedby="helpId" required autocomplete="off" placeholder="Max" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessINSStartMin" aria-describedby="helpId" required autocomplete="off" placeholder="Min" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessINSStartNom" aria-describedby="helpId" required autocomplete="off" placeholder="Nom" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessINSStartMax" aria-describedby="helpId" required autocomplete="off" placeholder="Max" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessOSCStartMin" aria-describedby="helpId" required autocomplete="off" placeholder="Min" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessOSCStartNom" aria-describedby="helpId" required autocomplete="off" placeholder="Nom" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessOSCStartMax" aria-describedby="helpId" required autocomplete="off" placeholder="Max" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessISCEndMin" aria-describedby="helpId" required autocomplete="off" placeholder="Min" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessISCEndNom" aria-describedby="helpId" required autocomplete="off" placeholder="Nom" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessISCEndMax" aria-describedby="helpId" required autocomplete="off" placeholder="Max" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessINSEndMin" aria-describedby="helpId" required autocomplete="off" placeholder="Min" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessINSEndNom" aria-describedby="helpId" required autocomplete="off" placeholder="Nom" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessINSEndMax" aria-describedby="helpId" required autocomplete="off" placeholder="Max" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="thicknessOSCEndMin" aria-describedby="helpId" required autocomplete="off" placeholder="Min" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessOSCEndNom" aria-describedby="helpId" required autocomplete="off" placeholder="Nom" required>
                                    <input type="text" class="form-control d-inline input" name="thicknessOSCEndMax" aria-describedby="helpId" required autocomplete="off" placeholder="Max" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="ISO">
        <div class="box clearfix">
            ...
            <form action="{{ route('CCVInsulation.iso') }}">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="item">
    ...
    <div id="Data" data-logoSrc="{{ asset('layout/images/Home/logo.gif') }}">
        <div class="jopOrderNumber w-50 m-auto">
            ...
            <form action="{{ route('CCVInsulation.get') }}" class="clearfix">
                @csrf
                <div class="form-group">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.standard.CCVInsulation') }}"><button class="btn btn-CCVInsulation float-left">Show Standards</button></a>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Actual/ShowActualCCVInsulation.js') }}"></script>
