...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('layout/css/ShowData/Printer/Screen/PrinterScreen.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.actual.screen') }}">Screen</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Screen Actual Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('screen.edit.row') }}" class="clearfix">
                @csrf
                ...
                <div class="row actual">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Color :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="color" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="tapeWeight" aria-describedby="helpId" required autocomplete="off">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="wireWeight" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="fourthInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="overLapActual1" aria-describedby="helpId" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="overLapActual2" aria-describedby="helpId" autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="overLapActual3" aria-describedby="helpId" autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="overLapActual4" aria-describedby="helpId" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="fourthInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="dimAfter1" aria-describedby="helpId" required autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="dimAfter2" aria-describedby="helpId" autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="dimAfter3" aria-describedby="helpId" autocomplete="off">
                                    <input type="text" class="form-control d-inline input" name="dimAfter4" aria-describedby="helpId" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="tapeDimention" aria-describedby="helpId" required autocomplete="off">
                            </div>
                        </div>
                    </div>
    ...
    <div id="Data" data-logoSrc="{{ asset('layout/images/Home/logo.gif') }}">
        <div class="jopOrderNumber w-50 m-auto">
            ...
            <form action="{{ route('screen.get') }}" class="clearfix">
                @csrf
                <div class="form-group">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.standard.screen') }}"><button class="btn btn-screen float-left">Show Standards</button></a>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-6 col-md-5">
                            <select class="form-control d-inline input" name="fillerName" id="FilterName" aria-describedby="helpId" data-last-selected="shift" required disabled>
                                ...
                                <option value="tapeWeight">Tape Weight</option>
                                <option value="wireWeight">Wire Weight</option>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Actual/ShowActualScreen.js') }}"></script>
