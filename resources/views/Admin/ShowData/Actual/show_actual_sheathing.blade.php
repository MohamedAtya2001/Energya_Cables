...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('layout/css/ShowData/Printer/Sheathing/PrinterSheathing.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.actual.sheathing') }}">Sheathing</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Sheathing Actual Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('sheathing.edit.row') }}" class="clearfix">
                @csrf
    ...
    <div id="ISO">
        <div class="box clearfix">
            ...
            <form action="{{ route('sheathing.iso') }}">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="item">
    ...
    <div id="Data" data-logoSrc="{{ asset('layout/images/Home/logo.gif') }}">
        <div class="jopOrderNumber w-50 m-auto">
            ...
            <form action="{{ route('sheathing.get') }}" class="clearfix">
                @csrf
                <div class="form-group">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.standard.sheathing') }}"><button class="btn btn-sheathing float-left">Show Standards</button></a>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Actual/ShowActualSheathing.js') }}"></script>
