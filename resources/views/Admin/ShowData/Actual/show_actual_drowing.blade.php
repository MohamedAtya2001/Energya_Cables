...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('layout/css/ShowData/Printer/Drowing/PrinterDrowing.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item active" href="{{ route('admin.show.actual.drowing') }}">Dowing</a>
    ...
    <div class="headLine my-4">
        <h1 class="m-auto">Drowing Actual Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('drowing.edit.row') }}" class="clearfix">
                @csrf
                ...
                <div class="row actual">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Machine :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="machine" data-error="machine" aria-describedby="helpId" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="coilNumber" data-error="coilNumber" aria-describedby="helpId" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item">
                            <div class="form-group">
                                ...
                                <div class="thirdInput">
                                    <input type="text" class="form-control d-inline ml-1 input" name="wireDimMinActual" aria-describedby="helpId" required placeholder="Min">
                                    <input type="text" class="form-control d-inline input" name="wireDimNomActual" aria-describedby="helpId" required placeholder="Nom">
                                    <input type="text" class="form-control d-inline input" name="wireDimMaxActual" aria-describedby="helpId" required placeholder="Max">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="elongationActual" data-error="elongationActual" aria-describedby="helpId" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Tensile :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="tensileActual" data-error="tensileActual" aria-describedby="helpId" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Cage :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="cage" data-error="cage" aria-describedby="helpId" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="outputCard" data-error="outputCard" aria-describedby="helpId" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Visual :</label>
                                <input type="text" class="form-control d-inline ml-2 input" name="visual" data-error="visual" aria-describedby="helpId" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Status :</label>
                                <select class="form-control d-inline ml-2 input" name="status" data-error="status" aria-describedby="helpId" required>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="productionOperator" data-error="productionOperator" aria-describedby="helpId" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Notes :</label>
                                <textarea type="text" class="form-control d-inline ml-2 input" maxlength="100" name="notes" data-error="notes" aria-describedby="helpId"></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <div id="Data" data-logoSrc="{{ asset('layout/images/Home/logo.gif') }}">
        ...
        <div class="jopOrderNumber w-50 m-auto">
            ...
            <form action="{{ route('drowing.get') }}" class="clearfix">
                @csrf
                <div class="form-group">
                    <label>Jop Order Number :</label>
                    <input type="text" class="form-control d-inline ml-4 input w-75" name="jopOrderNumber" aria-describedby="helpId" data-last-selected="shift" autocomplete="off" required>
                </div>
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.standard.drowing') }}"><button class="btn btn-drowing float-left">Show Standards</button></a>
                ...
                <div class="filterValue mx-auto">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-6 col-md-5">
                            <select class="form-control d-inline input" name="fillerName" id="FilterName" aria-describedby="helpId" required disabled>
                                <option value="shift">Shift</option>
                                <option value="added_by">Added By</option>
                                <option value="jopOrderNumber">Jop Order Number</option>
                                <option value="machine">Machine</option>
                                <option value="coilNumber">Coil Number</option>
                                <option value="cage">Cage</option>
                                <option value="outputCard">Output Card</option>
                                <option value="productionOperator">Production Operator</option>
                                <option value="notes" onclick="notesFilter(this)">Notes</option>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Actual/ShowActualDrowing.js') }}"></script>
