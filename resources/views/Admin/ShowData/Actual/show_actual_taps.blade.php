...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('layout/css/ShowData/Printer/Taps/PrinterTaps.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item active" href="{{ route('admin.show.actual.taps') }}">Taps</a>
    ...
    <div class="headLine my-5">
        <h1 class="m-auto">Taps Actual Sheets</h1>
    </div>
    ...
    <div id="Edit">
        <div class="box clearfix">
            ...
            <form action="{{ route('taps.edit.row') }}" class="clearfix">
                @csrf
                ...
                <div class="row actual">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="tapeDimentionActual" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="tapeWeightActual" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="overLapActual" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control d-inline ml-2 input" name="dimAfter" aria-describedby="helpId" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="item">
                            <div class="form-group">
                                <label>Notes :</label>
                                <textarea type="text" class="form-control d-inline input ml-2" maxlength="100" name="notes" aria-describedby="helpId"></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <div id="Data" data-logoSrc="{{ asset('layout/images/Home/logo.gif') }}">
        <div class="jopOrderNumber w-50 m-auto">
            ...
            <form action="{{ route('taps.get') }}" class="clearfix">
                @csrf
                <div class="form-group">
        ...
        <div class="button-print clearfix my-3">
            <div class="container">
                <a href="{{ route('admin.show.standard.taps') }}"><button class="btn btn-taps float-left">Show Standards</button></a>
    ...
    <script src="{{ asset('layout/JavaScript/ShowData/Actual/ShowActualTaps.js') }}"></script>
