...
class CreateInsualtionactualsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('insulationactuals', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('jopOrderNumber_id');
            $table->foreign('jopOrderNumber_id')->references('id')->on('insulationstandards');
    ...
    {
        Schema::dropIfExists('insulationactuals');
    }
}
