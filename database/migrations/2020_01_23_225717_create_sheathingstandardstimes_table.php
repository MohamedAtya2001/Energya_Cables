...
class CreateSheathingstandardstimesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sheathingstandardstimes', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('sheathingstandards_id');
            $table->foreign('sheathingstandards_id')->references('id')->on('sheathingstandards');
    ...
    {
        Schema::dropIfExists('sheathingstandardstimes');
    }
}
