...
class CreateSheathingactualstimesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sheathingactualstimes', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('sheathingactuals_id');
            $table->foreign('sheathingactuals_id')->references('id')->on('sheathingactuals');
    ...
    {
        Schema::dropIfExists('sheathingactualstimes');
    }
}
