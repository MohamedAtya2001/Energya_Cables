...
class CreateBeddingstandardstimesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('beddingstandardstimes', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('beddingstandards_id');
            $table->foreign('beddingstandards_id')->references('id')->on('beddingstandards');
    ...
    {
        Schema::dropIfExists('beddingstandardstimes');
    }
}
