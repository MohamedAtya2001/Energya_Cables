...
class CreateInsualtionactualstimesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('insulationactualstimes', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('insulationactuals_id');
            $table->foreign('insulationactuals_id')->references('id')->on('insulationactuals');
            ...
            $table->string('apperanceOfDrum_time', 100)->nullable();
            $table->string('colorActual_time', 100)->nullable();
            $table->string('message_time', 100)->nullable();
            ...
            $table->string('meterMeasuring_time', 100)->nullable();
    ...
    {
        Schema::dropIfExists('insulationactualstimes');
    }
}
